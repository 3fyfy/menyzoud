...
class SuccessMazad extends StatefulWidget {
  @override
  _SuccessMazadState createState() => _SuccessMazadState();
}

class _SuccessMazadState extends State<SuccessMazad> {
      ...
      children: images.map((url) {
        return Card(
            ...
            child: Directionality(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductSuccess(url,"كنبة سوداء",true),));
                },
                child: Container(
                      ...
                      Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text("انتهى المزاد",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.red),textAlign: TextAlign.left,),
                          )
